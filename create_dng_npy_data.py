...
if __name__ == '__main__':
    ...
    parser.add_argument("--root_hdr", type=str, default=os.path.join("/cs/labs/raananf/yael_vinker/data/hdr_hard_images"))
    parser.add_argument("--root_ldr", type=str, default=os.path.join("/cs/dataset/flickr30k/images"))
    parser.add_argument("--output_hdr", type=str, default=os.path.join("/cs/labs/raananf/yael_vinker/data/hdr_hard_images_log100"))
    ...
    # im_end = im_exp / 1000
    #
    # transfor_exp = transforms_.Exp(1000)
    # im_transform = transfor_exp(gray)
    #
    # images = [im1, np.array(im_transform.permute(1, 2, 0)), np.array(im_end.permute(1, 2, 0))]
    #
