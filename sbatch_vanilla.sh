...
result_dir_prefix="/cs/snapless/raananf/yael_vinker/02_15/vanilla/ssim_org_"
...
sbatch --mem=4000m -c1 --gres=gpu:1 --time=2-0 train.sh $change_random_seed $batch_size $num_epochs \
  ...
  $use_factorise_data $factor_coeff $add_clipping $use_normalization $normalization $last_layer $pyramid_pow
